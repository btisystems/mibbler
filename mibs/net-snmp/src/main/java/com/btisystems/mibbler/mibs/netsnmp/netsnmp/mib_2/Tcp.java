    ...
    implements Serializable, ITcp, IVariableBindingSetter
{
    ...
    public void setTcpHCInSegs(long tcpHCInSegs) {
        long oldValue = getTcpHCInSegs();
        this.tcpHCInSegs = tcpHCInSegs;
        notifyChange(17, oldValue, tcpHCInSegs);
    }
    ...
    public void setTcpHCOutSegs(long tcpHCOutSegs) {
        long oldValue = getTcpHCOutSegs();
        this.tcpHCOutSegs = tcpHCOutSegs;
        notifyChange(18, oldValue, tcpHCOutSegs);
    }
    ...
    public Tcp clone() {
        ...
        _copy.tcpHCInSegs = tcpHCInSegs;
        _copy.tcpHCOutSegs = tcpHCOutSegs;
        return _copy;
    }
    ...
    private static DeviceEntityDescription createEntityDescription() {
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(17, "tcpHCInSegs", DeviceEntityDescription.FieldType.UNSIGNED64, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(18, "tcpHCOutSegs", DeviceEntityDescription.FieldType.UNSIGNED64, -1));
        return description;
    }
