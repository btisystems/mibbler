...
package com.btisystems.mibbler.mibs.bti7000.bti7000_13_2_0.mib_2.rmon.filter.channeltable;
    ...
    implements Serializable, IChannelEntry, IIndexed, IVariableBindingSetter
{
    ...
    private static DeviceEntityDescription createEntityDescription() {
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(10, "channelDescription", DeviceEntityDescription.FieldType.STRING, 127));
        description.addField(new DeviceEntityDescription.FieldDescription(11, "channelOwner", DeviceEntityDescription.FieldType.STRING, 65535));
