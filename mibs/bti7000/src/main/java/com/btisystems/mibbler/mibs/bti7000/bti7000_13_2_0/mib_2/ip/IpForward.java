...
package com.btisystems.mibbler.mibs.bti7000.bti7000_13_2_0.mib_2.ip;

import java.io.Serializable;
import com.btisystems.mibbler.mibs.bti7000.interfaces.mib_2.ip.IIpForward;
    ...
    implements Serializable, IIpForward, IVariableBindingSetter
{
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("ipForwardNumber", ipForwardNumber).append("ipCidrRouteNumber", ipCidrRouteNumber).toString();
    }

    public int hashCode() {
        return new HashCodeBuilder().append(ipForwardNumber).append(ipCidrRouteNumber).toHashCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return new EqualsBuilder().append(ipForwardNumber, rhs.ipForwardNumber).append(ipCidrRouteNumber, rhs.ipCidrRouteNumber).isEquals();
    }
