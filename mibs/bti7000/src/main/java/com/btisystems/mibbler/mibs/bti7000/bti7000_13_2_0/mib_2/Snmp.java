...
package com.btisystems.mibbler.mibs.bti7000.bti7000_13_2_0.mib_2;

import java.io.Serializable;
import com.btisystems.mibbler.mibs.bti7000.interfaces.mib_2.ISnmp;
    ...
    implements Serializable, ISnmp, IVariableBindingSetter
{
    ...
    private int snmpInASNParseErrs1;
    ...
    public int getSnmpInASNParseErrs1() {
        return this.snmpInASNParseErrs1;
    }

    public void setSnmpInASNParseErrs1(int snmpInASNParseErrs1) {
        int oldValue = getSnmpInASNParseErrs1();
        this.snmpInASNParseErrs1 = snmpInASNParseErrs1;
        notifyChange(7, oldValue, snmpInASNParseErrs1);
    }
    ...
    public int getSnmpOutBadValues1() {
        return this.snmpOutBadValues1;
    }

    public void setSnmpOutBadValues1(int snmpOutBadValues1) {
        int oldValue = getSnmpOutBadValues1();
        this.snmpOutBadValues1 = snmpOutBadValues1;
        notifyChange(23, oldValue, snmpOutBadValues1);
    }
    ...
    public void set(VariableBinding binding) {
        switch (binding.getOid().get(7)) {
            ...
            case  6 :
                ...
                break;
            case  7 :
                setSnmpInASNParseErrs1(binding.getVariable().toInt());
                break;
            case  8 :
            ...
            case  22 :
                ...
                break;
            case  23 :
                setSnmpOutBadValues1(binding.getVariable().toInt());
                break;
            case  24 :
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("snmpInPkts", snmpInPkts).append("snmpOutPkts", snmpOutPkts).append("snmpInBadVersions", snmpInBadVersions).append("snmpInBadCommunityNames", snmpInBadCommunityNames).append("snmpInBadCommunityUses", snmpInBadCommunityUses).append("snmpInASNParseErrs", snmpInASNParseErrs).append("snmpInASNParseErrs1", snmpInASNParseErrs1).append("snmpInTooBigs", snmpInTooBigs).append("snmpInNoSuchNames", snmpInNoSuchNames).append("snmpInBadValues", snmpInBadValues).append("snmpInReadOnlys", snmpInReadOnlys).append("snmpInGenErrs", snmpInGenErrs).append("snmpInTotalReqVars", snmpInTotalReqVars).append("snmpInTotalSetVars", snmpInTotalSetVars).append("snmpInGetRequests", snmpInGetRequests).append("snmpInGetNexts", snmpInGetNexts).append("snmpInSetRequests", snmpInSetRequests).append("snmpInGetResponses", snmpInGetResponses).append("snmpInTraps", snmpInTraps).append("snmpOutTooBigs", snmpOutTooBigs).append("snmpOutNoSuchNames", snmpOutNoSuchNames).append("snmpOutBadValues", snmpOutBadValues).append("snmpOutBadValues1", snmpOutBadValues1).append("snmpOutGenErrs", snmpOutGenErrs).append("snmpOutGetRequests", snmpOutGetRequests).append("snmpOutGetNexts", snmpOutGetNexts).append("snmpOutSetRequests", snmpOutSetRequests).append("snmpOutGetResponses", snmpOutGetResponses).append("snmpOutTraps", snmpOutTraps).append("snmpEnableAuthenTraps", snmpEnableAuthenTraps).append("snmpSilentDrops", snmpSilentDrops).append("snmpProxyDrops", snmpProxyDrops).toString();
    }

    public int hashCode() {
        return new HashCodeBuilder().append(snmpInPkts).append(snmpOutPkts).append(snmpInBadVersions).append(snmpInBadCommunityNames).append(snmpInBadCommunityUses).append(snmpInASNParseErrs).append(snmpInASNParseErrs1).append(snmpInTooBigs).append(snmpInNoSuchNames).append(snmpInBadValues).append(snmpInReadOnlys).append(snmpInGenErrs).append(snmpInTotalReqVars).append(snmpInTotalSetVars).append(snmpInGetRequests).append(snmpInGetNexts).append(snmpInSetRequests).append(snmpInGetResponses).append(snmpInTraps).append(snmpOutTooBigs).append(snmpOutNoSuchNames).append(snmpOutBadValues).append(snmpOutBadValues1).append(snmpOutGenErrs).append(snmpOutGetRequests).append(snmpOutGetNexts).append(snmpOutSetRequests).append(snmpOutGetResponses).append(snmpOutTraps).append(snmpEnableAuthenTraps).append(snmpSilentDrops).append(snmpProxyDrops).toHashCode();
    }
    ...
    public Snmp clone() {
        ...
        _copy.snmpInASNParseErrs1 = snmpInASNParseErrs1;
        ...
        _copy.snmpOutBadValues1 = snmpOutBadValues1;
    ...
    private static DeviceEntityDescription createEntityDescription() {
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(7, "snmpInASNParseErrs1", DeviceEntityDescription.FieldType.INTEGER, -1));
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(23, "snmpOutBadValues1", DeviceEntityDescription.FieldType.INTEGER, -1));
