    ...
    extends AbstractRootEntity
{
    ...
    private NtpClientAssocTable ntpClientAssocTable;
    private XcvrProtGrpTable xcvrProtGrpTable;
    private OcnProtGrpTable ocnProtGrpTable;
    private StmnProtGrpTable stmnProtGrpTable;
    private DbBackupAndRestore dbBackupAndRestore;
    private SwUpgrade swUpgrade;
    private OcnLpbkOpTable ocnLpbkOpTable;
    private OcnProtSwOpTable ocnProtSwOpTable;
    private StsnProtSwOpTable stsnProtSwOpTable;
    private StmnLpbkOpTable stmnLpbkOpTable;
    private StmnProtSwOpTable stmnProtSwOpTable;
    private VcnProtSwOpTable vcnProtSwOpTable;
    private GeLpbkOpTable geLpbkOpTable;
    private FcLpbkOpTable fcLpbkOpTable;
    private BriLpbkOpTable briLpbkOpTable;
    private CpRestartOpTable cpRestartOpTable;
    private OaOOBRSDOpTable oaOOBRSDOpTable;
    private DataCommsPingTable dataCommsPingTable;
    private PluggableInvRestartOpTable pluggableInvRestartOpTable;
    private XcvrLpbkOpTable xcvrLpbkOpTable;
    private XcvrProtSwOpTable xcvrProtSwOpTable;
    private CpSynchronizationTable cpSynchronizationTable;
    private NetworkNeighborTable networkNeighborTable;
    private OspfGeneralTable ospfGeneralTable;
    private OspfIfTable ospfIfTable;
    private OspfLsdbTable ospfLsdbTable;
    private OspfNbrTable ospfNbrTable;
    private PvxL2IntfTable pvxL2IntfTable;
    private SetErrorInfo setErrorInfo;
    private ShelfInvTable shelfInvTable;
    private SlotInvTable slotInvTable;
    private PluggableInvTable pluggableInvTable;
    private SlotInvDataTable slotInvDataTable;
    private ShelfTable shelfTable;
    private CpTable cpTable;
    private OaTable oaTable;
    private FeTable feTable;
    private VcgTable vcgTable;
    private FcTable fcTable;
    private EthIntfTable ethIntfTable;
    private OdunTable odunTable;
    private BriTable briTable;
    private XcvrTable xcvrTable;
    private AmdTable amdTable;
    private PassivePortTable passivePortTable;
    private OcnTable ocnTable;
    private StsnTable stsnTable;
    private StmnTable stmnTable;
    private VcnTable vcnTable;
    private GeTable geTable;
    private OscTable oscTable;
    private NetMgmtTable netMgmtTable;
    private SerialTable serialTable;
    private Gcc0ConfigTable gcc0ConfigTable;
    private IpExtInterfaceTable ipExtInterfaceTable;
    private Conditions conditions;
    private NotifObjects notifObjects;
    private ActCondTable actCondTable;
    private ActAlarmTable actAlarmTable;
    private Administration administration;
    private Tl1UserTable tl1UserTable;
    private SnmpTrapRcvTable snmpTrapRcvTable;
    private XcvrXCTable xcvrXCTable;
    private VcgXCTable vcgXCTable;
    private StsnXCTable stsnXCTable;
    private VcnXCTable vcnXCTable;
    private OdunXCTable odunXCTable;
    private EvtNotificationObjects evtNotificationObjects;
    private DbChangeNotificationsObjects dbChangeNotificationsObjects;
    private NotificationObjects notificationObjects;
    ...
    public void setNetworkElement(NetworkElement networkElement) {
        NetworkElement oldValue = getNetworkElement();
        this.networkElement = networkElement;
        replaceChild(oldValue, networkElement);
    }
    ...
    public void setNtpClient(NtpClient ntpClient) {
        NtpClient oldValue = getNtpClient();
        this.ntpClient = ntpClient;
        replaceChild(oldValue, ntpClient);
    }

    public NtpClientAssocTable getNtpClientAssocTable() {
        return this.ntpClientAssocTable;
    }

    public void setNtpClientAssocTable(NtpClientAssocTable ntpClientAssocTable) {
        NtpClientAssocTable oldValue = getNtpClientAssocTable();
        this.ntpClientAssocTable = ntpClientAssocTable;
        replaceChild(oldValue, ntpClientAssocTable);
    }

    public XcvrProtGrpTable getXcvrProtGrpTable() {
        return this.xcvrProtGrpTable;
    }

    public void setXcvrProtGrpTable(XcvrProtGrpTable xcvrProtGrpTable) {
        XcvrProtGrpTable oldValue = getXcvrProtGrpTable();
        this.xcvrProtGrpTable = xcvrProtGrpTable;
        replaceChild(oldValue, xcvrProtGrpTable);
    }

    public OcnProtGrpTable getOcnProtGrpTable() {
        return this.ocnProtGrpTable;
    }

    public void setOcnProtGrpTable(OcnProtGrpTable ocnProtGrpTable) {
        OcnProtGrpTable oldValue = getOcnProtGrpTable();
        this.ocnProtGrpTable = ocnProtGrpTable;
        replaceChild(oldValue, ocnProtGrpTable);
    }

    public StmnProtGrpTable getStmnProtGrpTable() {
        return this.stmnProtGrpTable;
    }

    public void setStmnProtGrpTable(StmnProtGrpTable stmnProtGrpTable) {
        StmnProtGrpTable oldValue = getStmnProtGrpTable();
        this.stmnProtGrpTable = stmnProtGrpTable;
        replaceChild(oldValue, stmnProtGrpTable);
    }

    public DbBackupAndRestore getDbBackupAndRestore() {
        return this.dbBackupAndRestore;
    }

    public void setDbBackupAndRestore(DbBackupAndRestore dbBackupAndRestore) {
        DbBackupAndRestore oldValue = getDbBackupAndRestore();
        this.dbBackupAndRestore = dbBackupAndRestore;
        replaceChild(oldValue, dbBackupAndRestore);
    }

    public SwUpgrade getSwUpgrade() {
        return this.swUpgrade;
    }

    public void setSwUpgrade(SwUpgrade swUpgrade) {
        SwUpgrade oldValue = getSwUpgrade();
        this.swUpgrade = swUpgrade;
        replaceChild(oldValue, swUpgrade);
    }

    public OcnLpbkOpTable getOcnLpbkOpTable() {
        return this.ocnLpbkOpTable;
    }

    public void setOcnLpbkOpTable(OcnLpbkOpTable ocnLpbkOpTable) {
        OcnLpbkOpTable oldValue = getOcnLpbkOpTable();
        this.ocnLpbkOpTable = ocnLpbkOpTable;
        replaceChild(oldValue, ocnLpbkOpTable);
    }

    public OcnProtSwOpTable getOcnProtSwOpTable() {
        return this.ocnProtSwOpTable;
    }

    public void setOcnProtSwOpTable(OcnProtSwOpTable ocnProtSwOpTable) {
        OcnProtSwOpTable oldValue = getOcnProtSwOpTable();
        this.ocnProtSwOpTable = ocnProtSwOpTable;
        replaceChild(oldValue, ocnProtSwOpTable);
    }

    public StsnProtSwOpTable getStsnProtSwOpTable() {
        return this.stsnProtSwOpTable;
    }

    public void setStsnProtSwOpTable(StsnProtSwOpTable stsnProtSwOpTable) {
        StsnProtSwOpTable oldValue = getStsnProtSwOpTable();
        this.stsnProtSwOpTable = stsnProtSwOpTable;
        replaceChild(oldValue, stsnProtSwOpTable);
    }

    public StmnLpbkOpTable getStmnLpbkOpTable() {
        return this.stmnLpbkOpTable;
    }

    public void setStmnLpbkOpTable(StmnLpbkOpTable stmnLpbkOpTable) {
        StmnLpbkOpTable oldValue = getStmnLpbkOpTable();
        this.stmnLpbkOpTable = stmnLpbkOpTable;
        replaceChild(oldValue, stmnLpbkOpTable);
    }

    public StmnProtSwOpTable getStmnProtSwOpTable() {
        return this.stmnProtSwOpTable;
    }

    public void setStmnProtSwOpTable(StmnProtSwOpTable stmnProtSwOpTable) {
        StmnProtSwOpTable oldValue = getStmnProtSwOpTable();
        this.stmnProtSwOpTable = stmnProtSwOpTable;
        replaceChild(oldValue, stmnProtSwOpTable);
    }

    public VcnProtSwOpTable getVcnProtSwOpTable() {
        return this.vcnProtSwOpTable;
    }

    public void setVcnProtSwOpTable(VcnProtSwOpTable vcnProtSwOpTable) {
        VcnProtSwOpTable oldValue = getVcnProtSwOpTable();
        this.vcnProtSwOpTable = vcnProtSwOpTable;
        replaceChild(oldValue, vcnProtSwOpTable);
    }

    public GeLpbkOpTable getGeLpbkOpTable() {
        return this.geLpbkOpTable;
    }

    public void setGeLpbkOpTable(GeLpbkOpTable geLpbkOpTable) {
        GeLpbkOpTable oldValue = getGeLpbkOpTable();
        this.geLpbkOpTable = geLpbkOpTable;
        replaceChild(oldValue, geLpbkOpTable);
    }

    public FcLpbkOpTable getFcLpbkOpTable() {
        return this.fcLpbkOpTable;
    }

    public void setFcLpbkOpTable(FcLpbkOpTable fcLpbkOpTable) {
        FcLpbkOpTable oldValue = getFcLpbkOpTable();
        this.fcLpbkOpTable = fcLpbkOpTable;
        replaceChild(oldValue, fcLpbkOpTable);
    }

    public BriLpbkOpTable getBriLpbkOpTable() {
        return this.briLpbkOpTable;
    }

    public void setBriLpbkOpTable(BriLpbkOpTable briLpbkOpTable) {
        BriLpbkOpTable oldValue = getBriLpbkOpTable();
        this.briLpbkOpTable = briLpbkOpTable;
        replaceChild(oldValue, briLpbkOpTable);
    }

    public CpRestartOpTable getCpRestartOpTable() {
        return this.cpRestartOpTable;
    }

    public void setCpRestartOpTable(CpRestartOpTable cpRestartOpTable) {
        CpRestartOpTable oldValue = getCpRestartOpTable();
        this.cpRestartOpTable = cpRestartOpTable;
        replaceChild(oldValue, cpRestartOpTable);
    }

    public OaOOBRSDOpTable getOaOOBRSDOpTable() {
        return this.oaOOBRSDOpTable;
    }

    public void setOaOOBRSDOpTable(OaOOBRSDOpTable oaOOBRSDOpTable) {
        OaOOBRSDOpTable oldValue = getOaOOBRSDOpTable();
        this.oaOOBRSDOpTable = oaOOBRSDOpTable;
        replaceChild(oldValue, oaOOBRSDOpTable);
    }

    public DataCommsPingTable getDataCommsPingTable() {
        return this.dataCommsPingTable;
    }

    public void setDataCommsPingTable(DataCommsPingTable dataCommsPingTable) {
        DataCommsPingTable oldValue = getDataCommsPingTable();
        this.dataCommsPingTable = dataCommsPingTable;
        replaceChild(oldValue, dataCommsPingTable);
    }

    public PluggableInvRestartOpTable getPluggableInvRestartOpTable() {
        return this.pluggableInvRestartOpTable;
    }

    public void setPluggableInvRestartOpTable(PluggableInvRestartOpTable pluggableInvRestartOpTable) {
        PluggableInvRestartOpTable oldValue = getPluggableInvRestartOpTable();
        this.pluggableInvRestartOpTable = pluggableInvRestartOpTable;
        replaceChild(oldValue, pluggableInvRestartOpTable);
    }

    public XcvrLpbkOpTable getXcvrLpbkOpTable() {
        return this.xcvrLpbkOpTable;
    }

    public void setXcvrLpbkOpTable(XcvrLpbkOpTable xcvrLpbkOpTable) {
        XcvrLpbkOpTable oldValue = getXcvrLpbkOpTable();
        this.xcvrLpbkOpTable = xcvrLpbkOpTable;
        replaceChild(oldValue, xcvrLpbkOpTable);
    }

    public XcvrProtSwOpTable getXcvrProtSwOpTable() {
        return this.xcvrProtSwOpTable;
    }

    public void setXcvrProtSwOpTable(XcvrProtSwOpTable xcvrProtSwOpTable) {
        XcvrProtSwOpTable oldValue = getXcvrProtSwOpTable();
        this.xcvrProtSwOpTable = xcvrProtSwOpTable;
        replaceChild(oldValue, xcvrProtSwOpTable);
    }

    public CpSynchronizationTable getCpSynchronizationTable() {
        return this.cpSynchronizationTable;
    }

    public void setCpSynchronizationTable(CpSynchronizationTable cpSynchronizationTable) {
        CpSynchronizationTable oldValue = getCpSynchronizationTable();
        this.cpSynchronizationTable = cpSynchronizationTable;
        replaceChild(oldValue, cpSynchronizationTable);
    }

    public NetworkNeighborTable getNetworkNeighborTable() {
        return this.networkNeighborTable;
    }

    public void setNetworkNeighborTable(NetworkNeighborTable networkNeighborTable) {
        NetworkNeighborTable oldValue = getNetworkNeighborTable();
        this.networkNeighborTable = networkNeighborTable;
        replaceChild(oldValue, networkNeighborTable);
    }

    public OspfGeneralTable getOspfGeneralTable() {
        return this.ospfGeneralTable;
    }

    public void setOspfGeneralTable(OspfGeneralTable ospfGeneralTable) {
        OspfGeneralTable oldValue = getOspfGeneralTable();
        this.ospfGeneralTable = ospfGeneralTable;
        replaceChild(oldValue, ospfGeneralTable);
    }

    public OspfIfTable getOspfIfTable() {
        return this.ospfIfTable;
    }

    public void setOspfIfTable(OspfIfTable ospfIfTable) {
        OspfIfTable oldValue = getOspfIfTable();
        this.ospfIfTable = ospfIfTable;
        replaceChild(oldValue, ospfIfTable);
    }

    public OspfLsdbTable getOspfLsdbTable() {
        return this.ospfLsdbTable;
    }

    public void setOspfLsdbTable(OspfLsdbTable ospfLsdbTable) {
        OspfLsdbTable oldValue = getOspfLsdbTable();
        this.ospfLsdbTable = ospfLsdbTable;
        replaceChild(oldValue, ospfLsdbTable);
    }

    public OspfNbrTable getOspfNbrTable() {
        return this.ospfNbrTable;
    }

    public void setOspfNbrTable(OspfNbrTable ospfNbrTable) {
        OspfNbrTable oldValue = getOspfNbrTable();
        this.ospfNbrTable = ospfNbrTable;
        replaceChild(oldValue, ospfNbrTable);
    }

    public PvxL2IntfTable getPvxL2IntfTable() {
        return this.pvxL2IntfTable;
    }

    public void setPvxL2IntfTable(PvxL2IntfTable pvxL2IntfTable) {
        PvxL2IntfTable oldValue = getPvxL2IntfTable();
        this.pvxL2IntfTable = pvxL2IntfTable;
        replaceChild(oldValue, pvxL2IntfTable);
    }

    public SetErrorInfo getSetErrorInfo() {
        return this.setErrorInfo;
    }

    public void setSetErrorInfo(SetErrorInfo setErrorInfo) {
        SetErrorInfo oldValue = getSetErrorInfo();
        this.setErrorInfo = setErrorInfo;
        replaceChild(oldValue, setErrorInfo);
    }

    public ShelfInvTable getShelfInvTable() {
        return this.shelfInvTable;
    }

    public void setShelfInvTable(ShelfInvTable shelfInvTable) {
        ShelfInvTable oldValue = getShelfInvTable();
        this.shelfInvTable = shelfInvTable;
        replaceChild(oldValue, shelfInvTable);
    }

    public SlotInvTable getSlotInvTable() {
        return this.slotInvTable;
    }

    public void setSlotInvTable(SlotInvTable slotInvTable) {
        SlotInvTable oldValue = getSlotInvTable();
        this.slotInvTable = slotInvTable;
        replaceChild(oldValue, slotInvTable);
    }

    public PluggableInvTable getPluggableInvTable() {
        return this.pluggableInvTable;
    }

    public void setPluggableInvTable(PluggableInvTable pluggableInvTable) {
        PluggableInvTable oldValue = getPluggableInvTable();
        this.pluggableInvTable = pluggableInvTable;
        replaceChild(oldValue, pluggableInvTable);
    }

    public SlotInvDataTable getSlotInvDataTable() {
        return this.slotInvDataTable;
    }

    public void setSlotInvDataTable(SlotInvDataTable slotInvDataTable) {
        SlotInvDataTable oldValue = getSlotInvDataTable();
        this.slotInvDataTable = slotInvDataTable;
        replaceChild(oldValue, slotInvDataTable);
    }

    public ShelfTable getShelfTable() {
        return this.shelfTable;
    }

    public void setShelfTable(ShelfTable shelfTable) {
        ShelfTable oldValue = getShelfTable();
        this.shelfTable = shelfTable;
        replaceChild(oldValue, shelfTable);
    }

    public CpTable getCpTable() {
        return this.cpTable;
    }

    public void setCpTable(CpTable cpTable) {
        CpTable oldValue = getCpTable();
        this.cpTable = cpTable;
        replaceChild(oldValue, cpTable);
    }

    public OaTable getOaTable() {
        return this.oaTable;
    }

    public void setOaTable(OaTable oaTable) {
        OaTable oldValue = getOaTable();
        this.oaTable = oaTable;
        replaceChild(oldValue, oaTable);
    }

    public FeTable getFeTable() {
        return this.feTable;
    }

    public void setFeTable(FeTable feTable) {
        FeTable oldValue = getFeTable();
        this.feTable = feTable;
        replaceChild(oldValue, feTable);
    }

    public VcgTable getVcgTable() {
        return this.vcgTable;
    }

    public void setVcgTable(VcgTable vcgTable) {
        VcgTable oldValue = getVcgTable();
        this.vcgTable = vcgTable;
        replaceChild(oldValue, vcgTable);
    }

    public FcTable getFcTable() {
        return this.fcTable;
    }

    public void setFcTable(FcTable fcTable) {
        FcTable oldValue = getFcTable();
        this.fcTable = fcTable;
        replaceChild(oldValue, fcTable);
    }

    public EthIntfTable getEthIntfTable() {
        return this.ethIntfTable;
    }

    public void setEthIntfTable(EthIntfTable ethIntfTable) {
        EthIntfTable oldValue = getEthIntfTable();
        this.ethIntfTable = ethIntfTable;
        replaceChild(oldValue, ethIntfTable);
    }

    public OdunTable getOdunTable() {
        return this.odunTable;
    }

    public void setOdunTable(OdunTable odunTable) {
        OdunTable oldValue = getOdunTable();
        this.odunTable = odunTable;
        replaceChild(oldValue, odunTable);
    }

    public BriTable getBriTable() {
        return this.briTable;
    }

    public void setBriTable(BriTable briTable) {
        BriTable oldValue = getBriTable();
        this.briTable = briTable;
        replaceChild(oldValue, briTable);
    }

    public XcvrTable getXcvrTable() {
        return this.xcvrTable;
    }

    public void setXcvrTable(XcvrTable xcvrTable) {
        XcvrTable oldValue = getXcvrTable();
        this.xcvrTable = xcvrTable;
        replaceChild(oldValue, xcvrTable);
    }

    public AmdTable getAmdTable() {
        return this.amdTable;
    }

    public void setAmdTable(AmdTable amdTable) {
        AmdTable oldValue = getAmdTable();
        this.amdTable = amdTable;
        replaceChild(oldValue, amdTable);
    }

    public PassivePortTable getPassivePortTable() {
        return this.passivePortTable;
    }

    public void setPassivePortTable(PassivePortTable passivePortTable) {
        PassivePortTable oldValue = getPassivePortTable();
        this.passivePortTable = passivePortTable;
        replaceChild(oldValue, passivePortTable);
    }

    public OcnTable getOcnTable() {
        return this.ocnTable;
    }

    public void setOcnTable(OcnTable ocnTable) {
        OcnTable oldValue = getOcnTable();
        this.ocnTable = ocnTable;
        replaceChild(oldValue, ocnTable);
    }

    public StsnTable getStsnTable() {
        return this.stsnTable;
    }

    public void setStsnTable(StsnTable stsnTable) {
        StsnTable oldValue = getStsnTable();
        this.stsnTable = stsnTable;
        replaceChild(oldValue, stsnTable);
    }

    public StmnTable getStmnTable() {
        return this.stmnTable;
    }

    public void setStmnTable(StmnTable stmnTable) {
        StmnTable oldValue = getStmnTable();
        this.stmnTable = stmnTable;
        replaceChild(oldValue, stmnTable);
    }

    public VcnTable getVcnTable() {
        return this.vcnTable;
    }

    public void setVcnTable(VcnTable vcnTable) {
        VcnTable oldValue = getVcnTable();
        this.vcnTable = vcnTable;
        replaceChild(oldValue, vcnTable);
    }
    ...
    public void setGeTable(GeTable geTable) {
        GeTable oldValue = getGeTable();
        this.geTable = geTable;
        replaceChild(oldValue, geTable);
    }

    public OscTable getOscTable() {
        return this.oscTable;
    }

    public void setOscTable(OscTable oscTable) {
        OscTable oldValue = getOscTable();
        this.oscTable = oscTable;
        replaceChild(oldValue, oscTable);
    }

    public NetMgmtTable getNetMgmtTable() {
        return this.netMgmtTable;
    }

    public void setNetMgmtTable(NetMgmtTable netMgmtTable) {
        NetMgmtTable oldValue = getNetMgmtTable();
        this.netMgmtTable = netMgmtTable;
        replaceChild(oldValue, netMgmtTable);
    }

    public SerialTable getSerialTable() {
        return this.serialTable;
    }

    public void setSerialTable(SerialTable serialTable) {
        SerialTable oldValue = getSerialTable();
        this.serialTable = serialTable;
        replaceChild(oldValue, serialTable);
    }

    public Gcc0ConfigTable getGcc0ConfigTable() {
        return this.gcc0ConfigTable;
    }

    public void setGcc0ConfigTable(Gcc0ConfigTable gcc0ConfigTable) {
        Gcc0ConfigTable oldValue = getGcc0ConfigTable();
        this.gcc0ConfigTable = gcc0ConfigTable;
        replaceChild(oldValue, gcc0ConfigTable);
    }

    public IpExtInterfaceTable getIpExtInterfaceTable() {
        return this.ipExtInterfaceTable;
    }

    public void setIpExtInterfaceTable(IpExtInterfaceTable ipExtInterfaceTable) {
        IpExtInterfaceTable oldValue = getIpExtInterfaceTable();
        this.ipExtInterfaceTable = ipExtInterfaceTable;
        replaceChild(oldValue, ipExtInterfaceTable);
    }
    ...
    public void setConditions(Conditions conditions) {
        Conditions oldValue = getConditions();
        this.conditions = conditions;
        replaceChild(oldValue, conditions);
    }

    public NotifObjects getNotifObjects() {
        return this.notifObjects;
    }

    public void setNotifObjects(NotifObjects notifObjects) {
        NotifObjects oldValue = getNotifObjects();
        this.notifObjects = notifObjects;
        replaceChild(oldValue, notifObjects);
    }

    public ActCondTable getActCondTable() {
        return this.actCondTable;
    }

    public void setActCondTable(ActCondTable actCondTable) {
        ActCondTable oldValue = getActCondTable();
        this.actCondTable = actCondTable;
        replaceChild(oldValue, actCondTable);
    }

    public ActAlarmTable getActAlarmTable() {
        return this.actAlarmTable;
    }

    public void setActAlarmTable(ActAlarmTable actAlarmTable) {
        ActAlarmTable oldValue = getActAlarmTable();
        this.actAlarmTable = actAlarmTable;
        replaceChild(oldValue, actAlarmTable);
    }
    ...
    public I_Device clone() {
        ...
        if (networkElement!= null) {
            _copy.networkElement = networkElement.clone();
            _copy.networkElement.set_ParentEntity(_copy);
        }
        if (ntpClient!= null) {
            _copy.ntpClient = ntpClient.clone();
            _copy.ntpClient.set_ParentEntity(_copy);
        }
        if (ntpClientAssocTable!= null) {
            _copy.ntpClientAssocTable = ntpClientAssocTable.clone();
            _copy.ntpClientAssocTable.set_ParentEntity(_copy);
        }
        if (xcvrProtGrpTable!= null) {
            _copy.xcvrProtGrpTable = xcvrProtGrpTable.clone();
            _copy.xcvrProtGrpTable.set_ParentEntity(_copy);
        }
        if (ocnProtGrpTable!= null) {
            _copy.ocnProtGrpTable = ocnProtGrpTable.clone();
            _copy.ocnProtGrpTable.set_ParentEntity(_copy);
        }
        if (stmnProtGrpTable!= null) {
            _copy.stmnProtGrpTable = stmnProtGrpTable.clone();
            _copy.stmnProtGrpTable.set_ParentEntity(_copy);
        }
        if (dbBackupAndRestore!= null) {
            _copy.dbBackupAndRestore = dbBackupAndRestore.clone();
            _copy.dbBackupAndRestore.set_ParentEntity(_copy);
        }
        if (swUpgrade!= null) {
            _copy.swUpgrade = swUpgrade.clone();
            _copy.swUpgrade.set_ParentEntity(_copy);
        }
        if (ocnLpbkOpTable!= null) {
            _copy.ocnLpbkOpTable = ocnLpbkOpTable.clone();
            _copy.ocnLpbkOpTable.set_ParentEntity(_copy);
        }
        if (ocnProtSwOpTable!= null) {
            _copy.ocnProtSwOpTable = ocnProtSwOpTable.clone();
            _copy.ocnProtSwOpTable.set_ParentEntity(_copy);
        }
        if (stsnProtSwOpTable!= null) {
            _copy.stsnProtSwOpTable = stsnProtSwOpTable.clone();
            _copy.stsnProtSwOpTable.set_ParentEntity(_copy);
        }
        if (stmnLpbkOpTable!= null) {
            _copy.stmnLpbkOpTable = stmnLpbkOpTable.clone();
            _copy.stmnLpbkOpTable.set_ParentEntity(_copy);
        }
        if (stmnProtSwOpTable!= null) {
            _copy.stmnProtSwOpTable = stmnProtSwOpTable.clone();
            _copy.stmnProtSwOpTable.set_ParentEntity(_copy);
        }
        if (vcnProtSwOpTable!= null) {
            _copy.vcnProtSwOpTable = vcnProtSwOpTable.clone();
            _copy.vcnProtSwOpTable.set_ParentEntity(_copy);
        }
        if (geLpbkOpTable!= null) {
            _copy.geLpbkOpTable = geLpbkOpTable.clone();
            _copy.geLpbkOpTable.set_ParentEntity(_copy);
        }
        if (fcLpbkOpTable!= null) {
            _copy.fcLpbkOpTable = fcLpbkOpTable.clone();
            _copy.fcLpbkOpTable.set_ParentEntity(_copy);
        }
        if (briLpbkOpTable!= null) {
            _copy.briLpbkOpTable = briLpbkOpTable.clone();
            _copy.briLpbkOpTable.set_ParentEntity(_copy);
        }
        if (cpRestartOpTable!= null) {
            _copy.cpRestartOpTable = cpRestartOpTable.clone();
            _copy.cpRestartOpTable.set_ParentEntity(_copy);
        }
        if (oaOOBRSDOpTable!= null) {
            _copy.oaOOBRSDOpTable = oaOOBRSDOpTable.clone();
            _copy.oaOOBRSDOpTable.set_ParentEntity(_copy);
        }
        if (dataCommsPingTable!= null) {
            _copy.dataCommsPingTable = dataCommsPingTable.clone();
            _copy.dataCommsPingTable.set_ParentEntity(_copy);
        }
        if (pluggableInvRestartOpTable!= null) {
            _copy.pluggableInvRestartOpTable = pluggableInvRestartOpTable.clone();
            _copy.pluggableInvRestartOpTable.set_ParentEntity(_copy);
        }
        if (xcvrLpbkOpTable!= null) {
            _copy.xcvrLpbkOpTable = xcvrLpbkOpTable.clone();
            _copy.xcvrLpbkOpTable.set_ParentEntity(_copy);
        }
        if (xcvrProtSwOpTable!= null) {
            _copy.xcvrProtSwOpTable = xcvrProtSwOpTable.clone();
            _copy.xcvrProtSwOpTable.set_ParentEntity(_copy);
        }
        if (cpSynchronizationTable!= null) {
            _copy.cpSynchronizationTable = cpSynchronizationTable.clone();
            _copy.cpSynchronizationTable.set_ParentEntity(_copy);
        }
        if (networkNeighborTable!= null) {
            _copy.networkNeighborTable = networkNeighborTable.clone();
            _copy.networkNeighborTable.set_ParentEntity(_copy);
        }
        if (ospfGeneralTable!= null) {
            _copy.ospfGeneralTable = ospfGeneralTable.clone();
            _copy.ospfGeneralTable.set_ParentEntity(_copy);
        }
        if (ospfIfTable!= null) {
            _copy.ospfIfTable = ospfIfTable.clone();
            _copy.ospfIfTable.set_ParentEntity(_copy);
        }
        if (ospfLsdbTable!= null) {
            _copy.ospfLsdbTable = ospfLsdbTable.clone();
            _copy.ospfLsdbTable.set_ParentEntity(_copy);
        }
        if (ospfNbrTable!= null) {
            _copy.ospfNbrTable = ospfNbrTable.clone();
            _copy.ospfNbrTable.set_ParentEntity(_copy);
        }
        if (pvxL2IntfTable!= null) {
            _copy.pvxL2IntfTable = pvxL2IntfTable.clone();
            _copy.pvxL2IntfTable.set_ParentEntity(_copy);
        }
        if (setErrorInfo!= null) {
            _copy.setErrorInfo = setErrorInfo.clone();
            _copy.setErrorInfo.set_ParentEntity(_copy);
        }
        if (shelfInvTable!= null) {
            _copy.shelfInvTable = shelfInvTable.clone();
            _copy.shelfInvTable.set_ParentEntity(_copy);
        }
        if (slotInvTable!= null) {
            _copy.slotInvTable = slotInvTable.clone();
            _copy.slotInvTable.set_ParentEntity(_copy);
        }
        if (pluggableInvTable!= null) {
            _copy.pluggableInvTable = pluggableInvTable.clone();
            _copy.pluggableInvTable.set_ParentEntity(_copy);
        }
        if (slotInvDataTable!= null) {
            _copy.slotInvDataTable = slotInvDataTable.clone();
            _copy.slotInvDataTable.set_ParentEntity(_copy);
        }
        if (shelfTable!= null) {
            _copy.shelfTable = shelfTable.clone();
            _copy.shelfTable.set_ParentEntity(_copy);
        }
        if (cpTable!= null) {
            _copy.cpTable = cpTable.clone();
            _copy.cpTable.set_ParentEntity(_copy);
        }
        if (oaTable!= null) {
            _copy.oaTable = oaTable.clone();
            _copy.oaTable.set_ParentEntity(_copy);
        }
        if (feTable!= null) {
            _copy.feTable = feTable.clone();
            _copy.feTable.set_ParentEntity(_copy);
        }
        if (vcgTable!= null) {
            _copy.vcgTable = vcgTable.clone();
            _copy.vcgTable.set_ParentEntity(_copy);
        }
        if (fcTable!= null) {
            _copy.fcTable = fcTable.clone();
            _copy.fcTable.set_ParentEntity(_copy);
        }
        if (ethIntfTable!= null) {
            _copy.ethIntfTable = ethIntfTable.clone();
            _copy.ethIntfTable.set_ParentEntity(_copy);
        }
        if (odunTable!= null) {
            _copy.odunTable = odunTable.clone();
            _copy.odunTable.set_ParentEntity(_copy);
        }
        if (briTable!= null) {
            _copy.briTable = briTable.clone();
            _copy.briTable.set_ParentEntity(_copy);
        }
        if (xcvrTable!= null) {
            _copy.xcvrTable = xcvrTable.clone();
            _copy.xcvrTable.set_ParentEntity(_copy);
        }
        if (amdTable!= null) {
            _copy.amdTable = amdTable.clone();
            _copy.amdTable.set_ParentEntity(_copy);
        }
        if (passivePortTable!= null) {
            _copy.passivePortTable = passivePortTable.clone();
            _copy.passivePortTable.set_ParentEntity(_copy);
        }
        if (ocnTable!= null) {
            _copy.ocnTable = ocnTable.clone();
            _copy.ocnTable.set_ParentEntity(_copy);
        }
        if (stsnTable!= null) {
            _copy.stsnTable = stsnTable.clone();
            _copy.stsnTable.set_ParentEntity(_copy);
        }
        if (stmnTable!= null) {
            _copy.stmnTable = stmnTable.clone();
            _copy.stmnTable.set_ParentEntity(_copy);
        }
        if (vcnTable!= null) {
            _copy.vcnTable = vcnTable.clone();
            _copy.vcnTable.set_ParentEntity(_copy);
        }
        if (geTable!= null) {
            _copy.geTable = geTable.clone();
            _copy.geTable.set_ParentEntity(_copy);
        }
        if (oscTable!= null) {
            _copy.oscTable = oscTable.clone();
            _copy.oscTable.set_ParentEntity(_copy);
        }
        if (netMgmtTable!= null) {
            _copy.netMgmtTable = netMgmtTable.clone();
            _copy.netMgmtTable.set_ParentEntity(_copy);
        }
        if (serialTable!= null) {
            _copy.serialTable = serialTable.clone();
            _copy.serialTable.set_ParentEntity(_copy);
        }
        if (gcc0ConfigTable!= null) {
            _copy.gcc0ConfigTable = gcc0ConfigTable.clone();
            _copy.gcc0ConfigTable.set_ParentEntity(_copy);
        }
        if (ipExtInterfaceTable!= null) {
            _copy.ipExtInterfaceTable = ipExtInterfaceTable.clone();
            _copy.ipExtInterfaceTable.set_ParentEntity(_copy);
        }
        if (conditions!= null) {
            _copy.conditions = conditions.clone();
            _copy.conditions.set_ParentEntity(_copy);
        }
        if (notifObjects!= null) {
            _copy.notifObjects = notifObjects.clone();
            _copy.notifObjects.set_ParentEntity(_copy);
        }
        if (actCondTable!= null) {
            _copy.actCondTable = actCondTable.clone();
            _copy.actCondTable.set_ParentEntity(_copy);
        }
        if (actAlarmTable!= null) {
            _copy.actAlarmTable = actAlarmTable.clone();
            _copy.actAlarmTable.set_ParentEntity(_copy);
        }
        if (administration!= null) {
            _copy.administration = administration.clone();
            _copy.administration.set_ParentEntity(_copy);
        }
        if (tl1UserTable!= null) {
            _copy.tl1UserTable = tl1UserTable.clone();
            _copy.tl1UserTable.set_ParentEntity(_copy);
        }
        if (snmpTrapRcvTable!= null) {
            _copy.snmpTrapRcvTable = snmpTrapRcvTable.clone();
            _copy.snmpTrapRcvTable.set_ParentEntity(_copy);
        }
        if (xcvrXCTable!= null) {
            _copy.xcvrXCTable = xcvrXCTable.clone();
            _copy.xcvrXCTable.set_ParentEntity(_copy);
        }
        if (vcgXCTable!= null) {
            _copy.vcgXCTable = vcgXCTable.clone();
            _copy.vcgXCTable.set_ParentEntity(_copy);
        }
        if (stsnXCTable!= null) {
            _copy.stsnXCTable = stsnXCTable.clone();
            _copy.stsnXCTable.set_ParentEntity(_copy);
        }
        if (vcnXCTable!= null) {
            _copy.vcnXCTable = vcnXCTable.clone();
            _copy.vcnXCTable.set_ParentEntity(_copy);
        }
        if (odunXCTable!= null) {
            _copy.odunXCTable = odunXCTable.clone();
            _copy.odunXCTable.set_ParentEntity(_copy);
        }
        if (evtNotificationObjects!= null) {
            _copy.evtNotificationObjects = evtNotificationObjects.clone();
            _copy.evtNotificationObjects.set_ParentEntity(_copy);
        }
        if (dbChangeNotificationsObjects!= null) {
            _copy.dbChangeNotificationsObjects = dbChangeNotificationsObjects.clone();
            _copy.dbChangeNotificationsObjects.set_ParentEntity(_copy);
        }
        if (notificationObjects!= null) {
            _copy.notificationObjects = notificationObjects.clone();
            _copy.notificationObjects.set_ParentEntity(_copy);
        }
        return _copy;
    }

    public DeviceEntity[] getRoots() {
        return new DeviceEntity[] {networkElement, dot1dStpPortTable, ipAddrTable, ipRouteTable, administration, conditions, dot1qStaticUnicastTable, dot1qStaticMulticastTable, radiusAuthClient, ipNetToMediaTable, ipForward, dbBackupAndRestore, swUpgrade, oaOOBRSDOpTable, vcnProtSwOpTable, pvxL2IntfTable, dot1qVlan, dot1qBase, ntpClient, atTable, dot1qFdbTable, notificationObjects, protocolDistStatsTable, captureBufferTable, bufferControlTable, protocolDistControlTable, trapDestTable, dot1dPortGarpTable, serialConnectionTable, networkNeighborTable, ospfGeneralTable, ospfIfTable, shelfInvTable, alarmTable, ospfLsdbTable, slotInvTable, serialConfigTable, ospfNbrTable, pluggableInvTable, netConfigTable, slotInvDataTable, dot1qTpFdbTable, dot1qTpGroupTable, dot1qForwardAllTable, dot1qForwardUnregisteredTable, hostTimeTable, hostControl2Table, cpSynchronizationTable, hostControlTable, hostTable, radiusAuthServerTable, dot1dBasePortTable, egpNeighTable, ifTable, udpTable, ntpClientAssocTable, probeConfig, ifMIBObjects, addressMap, protocolDir, dot1dPortPriorityTable, dot1dUserPriorityRegenTable, dbChangeNotificationsObjects, tcpConnTable, radiusAccClient, dot1dStaticTable, evtNotificationObjects, egp, xcvrXCTable, tcp, udp, odunXCTable, dot1dBase, vcnXCTable, stsnXCTable, vcgXCTable, dot1dTp, pluggableInvRestartOpTable, dot1dStp, tl1UserTable, actAlarmTable, system, actCondTable, snmpTrapRcvTable, eventTable, logTable, notifObjects, dot1dPortOutboundAccessPriorityTable, icmp, dot1dTrafficClassTable, ip, interfaces, hlMatrixControlTable, xcvrTable, nlMatrixSDTable, oaTable, fcLpbkOpTable, hostTopNControlTable, nlMatrixTopNTable, stsnTable, ocnTable, nlMatrixDSTable, passivePortTable, hostTopNTable, nlMatrixTopNControlTable, amdTable, ifRcvAddressTable, ifTestTable, geTable, snmp, vcnTable, stmnTable, alHostTable, cpTable, ifStackTable, shelfTable, ifXTable, channelTable, protocolDirTable, gcc0ConfigTable, channel2Table, ipExtInterfaceTable, filter2Table, netMgmtTable, serialTable, nlHostTable, oscTable, hlHostControlTable, addressMapControlTable, filterTable, addressMapTable, usrHistoryControlTable, usrHistoryObjectTable, usrHistoryTable, alMatrixSDTable, stsnProtSwOpTable, alMatrixDSTable, alMatrixTopNControlTable, alMatrixTopNTable, sysORTable, historyControlTable, etherHistoryTable, historyControl2Table, ocnProtGrpTable, dot1dTpPortOverflowTable, stmnProtGrpTable, dot1dTpHCPortTable, tokenRingMLHistoryTable, dot1dTpPortTable, tokenRingPHistoryTable, dot1dTpFdbTable, tokenRingPStats2Table, etherStats2Table, tokenRingMLStats2Table, xcvrProtGrpTable, tokenRingMLStatsTable, tokenRingPStatsTable, etherStatsTable, ethIntfTable, dot1dPortCapabilitiesTable, odunTable, fcTable, briTable, dataCommsPingTable, dot1qVlanStaticTable, dot1qVlanCurrentTable, xcvrProtSwOpTable, dot1qPortVlanHCStatisticsTable, xcvrLpbkOpTable, dot1qPortVlanStatisticsTable, dot1qPortVlanTable, dot1qLearningConstraintsTable, ipCidrRouteTable, briLpbkOpTable, ipForwardTable, setErrorInfo, matrixControl2Table, ringStationTable, matrixDSTable, ringStationOrderTable, ringStationControlTable, sourceRoutingStatsTable, cpRestartOpTable, ringStationControl2Table, matrixSDTable, ringStationConfigControlTable, vcgTable, matrixControlTable, ringStationConfigTable, feTable, geLpbkOpTable, sourceRoutingStats2Table, stmnLpbkOpTable, radiusAccServerTable, ocnProtSwOpTable, ocnLpbkOpTable, dot1dPortGmrpTable, stmnProtSwOpTable, dot1dExtBase };
    }
