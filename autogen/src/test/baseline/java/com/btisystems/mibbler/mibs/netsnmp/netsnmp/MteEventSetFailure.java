...
public class MteEventSetFailure
    ...
    implements Serializable, INotification
{
    ...
    public boolean equals(Object obj) {
        ...
        MteEventSetFailure rhs = ((MteEventSetFailure) obj);
    ...
    public MteEventSetFailure clone() {
        MteEventSetFailure _copy = new MteEventSetFailure();
    ...
    private static DeviceEntityDescription createEntityDescription() {
        DeviceEntityDescription description = new DeviceEntityDescription(new OID("1.3.6.1.2.1.88.2.0.5"));
