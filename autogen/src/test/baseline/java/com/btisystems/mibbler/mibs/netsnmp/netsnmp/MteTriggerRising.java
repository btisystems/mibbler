    ...
    implements Serializable, INotification
{
    ...
    public boolean equals(Object obj) {
        ...
        MteTriggerRising rhs = ((MteTriggerRising) obj);
    ...
    public MteTriggerRising clone() {
        MteTriggerRising _copy = new MteTriggerRising();
    ...
    private static DeviceEntityDescription createEntityDescription() {
        DeviceEntityDescription description = new DeviceEntityDescription(new OID("1.3.6.1.2.1.88.2.0.2"));
