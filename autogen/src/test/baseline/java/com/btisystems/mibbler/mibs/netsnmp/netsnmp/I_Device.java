    ...
    extends AbstractRootEntity
{
    ...
    public DeviceEntity[] getRoots() {
        return new DeviceEntity[] {interfaces, icmp, ip, system, icmpMsgStatsTable, sysORTable, dot3HCStatsTable, icmpStatsTable, ifMIBObjects, sctpLookupRemIPAddrTable, mteObjectsTable, udp, mteTrigger, tcp, mteResource, mteEvent, egp, agentxConnectionTable, snmp, nlmLogTable, nlmLogVariableTable, hostTimeTable, hostTable, hostControlTable, ipv6IfTable, hrSWRunPerfTable, ipv6IfStatsTable, captureBufferTable, assocTable, ipv6AddrPrefixTable, bufferControlTable, applTable, ipv6AddrTable, egpNeighTable, tcpListenerTable, ipIfStatsTable, tcpConnectionTable, ipSystemStatsTable, nlmConfig, ipv6TcpConnTable, tcpConnTable, nlmStats, mteEventTable, mteEventSetTable, mteEventNotificationTable, agentxSessionTable, ifInvStackTable, smExtsnTable, smLangTable, alarmTable, filterTable, hrStorageTable, channelTable, hrSWInstalledTable, smRunTable, smLaunchTable, ipv6UdpTable, udpTable, udpEndpointTable, ipRouteTable, ipAddrTable, atTable, dot3ControlTable, dot3CollTable, dot3StatsTable, smScriptTable, hrSWInstalled, ipv6InterfaceTable, ipAddressPrefixTable, ipTrafficStats, nlmConfigLogTable, etherHistoryTable, schedObjects, historyControlTable, hrFSTable, ipv4InterfaceTable, matrixSDTable, ipForwardTable, matrixControlTable, ipNetToMediaTable, ipForward, hrStorage, hrDeviceTable, hrSystem, hrProcessorTable, inetCidrRouteTable, hrSWRun, ipCidrRouteTable, matrixDSTable, ipv6IfIcmpTable, hrDiskStorageTable, hrPartitionTable, smCodeTable, hrNetworkTable, hrPrinterTable, agentxRegistrationTable, sctpLookupRemPortTable, sctpLookupLocalPortTable, sctpAssocRemAddrTable, sctpAssocLocalAddrTable, sctpLookupRemPrimIPAddrTable, sctpLookupRemHostNameTable, agentxRegistration, ifTestTable, ifRcvAddressTable, sctpAssocTable, ifXTable, ipv6RouteTable, sctpParams, ifTable, ifStackTable, agentxGeneral, sctpStats, agentxConnection, ipv6NetToMediaTable, agentxSession, ipDefaultRouterTable, ipv6RouterAdvertTable, ipAddressTable, ipv6ScopeZoneIndexTable, ipNetToPhysicalTable, mteTriggerTable, mteTriggerExistenceTable, mteTriggerDeltaTable, mteTriggerThresholdTable, dismanEventMIBNotificationObjects, mteTriggerBooleanTable, ipv6MIBObjects, mtaGroupAssociationTable, mtaGroupTable, mtaGroupErrorTable, schedTable, nlmStatsLogTable, etherStatsTable, hostTopNTable, hostTopNControlTable, logTable, hrSWRunTable, eventTable, mtaTable };
    }
