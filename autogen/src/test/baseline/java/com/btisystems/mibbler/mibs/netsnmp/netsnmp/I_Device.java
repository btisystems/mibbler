    ...
    extends AbstractRootEntity
{
    ...
    public DeviceEntity[] getRoots() {
        return new DeviceEntity[] {system, sysORTable, dot3HCStatsTable, dot3StatsTable, dot3CollTable, dot3ControlTable, sctpStats, sctpLookupRemIPAddrTable, sctpParams, sctpAssocTable, sctpAssocLocalAddrTable, sctpAssocRemAddrTable, sctpLookupLocalPortTable, sctpLookupRemPortTable, sctpLookupRemHostNameTable, sctpLookupRemPrimIPAddrTable, snmp, etherStatsTable, historyControlTable, etherHistoryTable, alarmTable, hostControlTable, hostTable, hostTimeTable, hostTopNControlTable, hostTopNTable, matrixControlTable, matrixSDTable, matrixDSTable, filterTable, channelTable, bufferControlTable, captureBufferTable, eventTable, logTable, interfaces, ifTable, hrSystem, hrStorage, hrStorageTable, hrDeviceTable, hrProcessorTable, hrNetworkTable, hrPrinterTable, hrDiskStorageTable, hrPartitionTable, hrFSTable, hrSWRun, hrSWRunTable, hrSWRunPerfTable, hrSWInstalled, hrSWInstalledTable, applTable, assocTable, mtaTable, mtaGroupTable, mtaGroupAssociationTable, mtaGroupErrorTable, atTable, ifMIBObjects, ifXTable, ifStackTable, ifTestTable, ifRcvAddressTable, ip, ipAddrTable, ipRouteTable, ipNetToMediaTable, ipForward, ipForwardTable, ipCidrRouteTable, inetCidrRouteTable, ipv4InterfaceTable, ipv6InterfaceTable, ipTrafficStats, ipSystemStatsTable, ipIfStatsTable, ipAddressPrefixTable, ipAddressTable, ipNetToPhysicalTable, ipv6ScopeZoneIndexTable, ipDefaultRouterTable, ipv6RouterAdvertTable, icmp, icmpStatsTable, icmpMsgStatsTable, ipv6MIBObjects, ipv6RouteTable, ipv6NetToMediaTable, ipv6IfTable, ipv6IfStatsTable, ipv6AddrPrefixTable, ipv6AddrTable, ipv6IfIcmpTable, tcp, tcpConnTable, ipv6TcpConnTable, tcpConnectionTable, tcpListenerTable, schedObjects, schedTable, smLangTable, smExtsnTable, smScriptTable, smCodeTable, smLaunchTable, smRunTable, udp, udpTable, ipv6UdpTable, udpEndpointTable, agentxGeneral, agentxConnection, agentxConnectionTable, agentxSession, agentxSessionTable, agentxRegistration, agentxRegistrationTable, ifInvStackTable, egp, egpNeighTable, mteResource, mteTrigger, mteTriggerTable, mteTriggerDeltaTable, mteTriggerExistenceTable, mteTriggerBooleanTable, mteTriggerThresholdTable, mteObjectsTable, mteEvent, mteEventTable, mteEventNotificationTable, mteEventSetTable, dismanEventMIBNotificationObjects, nlmConfig, nlmConfigLogTable, nlmStats, nlmStatsLogTable, nlmLogTable, nlmLogVariableTable };
    }
