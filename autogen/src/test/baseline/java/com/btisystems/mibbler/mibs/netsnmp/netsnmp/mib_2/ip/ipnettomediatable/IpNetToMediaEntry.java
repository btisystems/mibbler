...
package com.btisystems.mibbler.mibs.netsnmp.netsnmp.mib_2.ip.ipnettomediatable;
    ...
    implements Serializable, IIpNetToMediaEntry, IIndexed, IVariableBindingSetter
{
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("ipNetToMediaIfIndex", ipNetToMediaIfIndex).append("ipNetToMediaPhysAddress", ipNetToMediaPhysAddress).append("ipNetToMediaNetAddress", ipNetToMediaNetAddress).append("ipNetToMediaType", ipNetToMediaType).append("_index", _index).toString();
    }

    public int hashCode() {
        return new HashCodeBuilder().append(ipNetToMediaIfIndex).append(ipNetToMediaPhysAddress).append(ipNetToMediaNetAddress).append(ipNetToMediaType).append(_index).toHashCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return new EqualsBuilder().append(ipNetToMediaIfIndex, rhs.ipNetToMediaIfIndex).append(ipNetToMediaPhysAddress, rhs.ipNetToMediaPhysAddress).append(ipNetToMediaNetAddress, rhs.ipNetToMediaNetAddress).append(ipNetToMediaType, rhs.ipNetToMediaType).append(_index, rhs._index).isEquals();
    }
