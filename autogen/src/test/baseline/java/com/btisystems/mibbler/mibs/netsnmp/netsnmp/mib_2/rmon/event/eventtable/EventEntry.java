    ...
    implements Serializable, IEventEntry, IIndexed, IVariableBindingSetter
{
    ...
    private static DeviceEntityDescription createEntityDescription() {
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(2, "eventDescription", DeviceEntityDescription.FieldType.STRING, 255));
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(6, "eventOwner", DeviceEntityDescription.FieldType.STRING, 127));
