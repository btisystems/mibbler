    ...
    implements Serializable, IIp, IVariableBindingSetter
{
    ...
    public void setIpv6IpForwarding(int ipv6IpForwarding) {
        int oldValue = getIpv6IpForwarding();
        this.ipv6IpForwarding = ipv6IpForwarding;
        notifyChange(25, oldValue, ipv6IpForwarding);
    }
    ...
    public void setIpv6IpDefaultHopLimit(int ipv6IpDefaultHopLimit) {
        int oldValue = getIpv6IpDefaultHopLimit();
        this.ipv6IpDefaultHopLimit = ipv6IpDefaultHopLimit;
        notifyChange(26, oldValue, ipv6IpDefaultHopLimit);
    }
    ...
    public void setIpv4InterfaceTableLastChange(int ipv4InterfaceTableLastChange) {
        int oldValue = getIpv4InterfaceTableLastChange();
        this.ipv4InterfaceTableLastChange = ipv4InterfaceTableLastChange;
        notifyChange(27, oldValue, ipv4InterfaceTableLastChange);
    }
    ...
    public void setIpv6InterfaceTableLastChange(int ipv6InterfaceTableLastChange) {
        int oldValue = getIpv6InterfaceTableLastChange();
        this.ipv6InterfaceTableLastChange = ipv6InterfaceTableLastChange;
        notifyChange(29, oldValue, ipv6InterfaceTableLastChange);
    }
    ...
    public void setIpAddressSpinLock(int ipAddressSpinLock) {
        int oldValue = getIpAddressSpinLock();
        this.ipAddressSpinLock = ipAddressSpinLock;
        notifyChange(33, oldValue, ipAddressSpinLock);
    }
    ...
    public void setIpv6RouterAdvertSpinLock(int ipv6RouterAdvertSpinLock) {
        int oldValue = getIpv6RouterAdvertSpinLock();
        this.ipv6RouterAdvertSpinLock = ipv6RouterAdvertSpinLock;
        notifyChange(38, oldValue, ipv6RouterAdvertSpinLock);
    }
    ...
    public void set(VariableBinding binding) {
        switch (binding.getOid().get(7)) {
            ...
            case  23 :
                ...
                break;
            case  25 :
                setIpv6IpForwarding(binding.getVariable().toInt());
                break;
            case  26 :
                setIpv6IpDefaultHopLimit(binding.getVariable().toInt());
                break;
            case  27 :
                setIpv4InterfaceTableLastChange(binding.getVariable().toInt());
                break;
            case  29 :
                setIpv6InterfaceTableLastChange(binding.getVariable().toInt());
                break;
            case  33 :
                setIpAddressSpinLock(binding.getVariable().toInt());
                break;
            case  38 :
                setIpv6RouterAdvertSpinLock(binding.getVariable().toInt());
                break;
        }
    }

    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("ipForwarding", ipForwarding).append("ipDefaultTTL", ipDefaultTTL).append("ipInReceives", ipInReceives).append("ipInHdrErrors", ipInHdrErrors).append("ipInAddrErrors", ipInAddrErrors).append("ipForwDatagrams", ipForwDatagrams).append("ipInUnknownProtos", ipInUnknownProtos).append("ipInDiscards", ipInDiscards).append("ipInDelivers", ipInDelivers).append("ipOutRequests", ipOutRequests).append("ipOutDiscards", ipOutDiscards).append("ipOutNoRoutes", ipOutNoRoutes).append("ipReasmTimeout", ipReasmTimeout).append("ipReasmReqds", ipReasmReqds).append("ipReasmOKs", ipReasmOKs).append("ipReasmFails", ipReasmFails).append("ipFragOKs", ipFragOKs).append("ipFragFails", ipFragFails).append("ipFragCreates", ipFragCreates).append("ipRoutingDiscards", ipRoutingDiscards).append("ipv6IpForwarding", ipv6IpForwarding).append("ipv6IpDefaultHopLimit", ipv6IpDefaultHopLimit).append("ipv4InterfaceTableLastChange", ipv4InterfaceTableLastChange).append("ipv6InterfaceTableLastChange", ipv6InterfaceTableLastChange).append("ipAddressSpinLock", ipAddressSpinLock).append("ipv6RouterAdvertSpinLock", ipv6RouterAdvertSpinLock).toString();
    }

    public int hashCode() {
        return new HashCodeBuilder().append(ipForwarding).append(ipDefaultTTL).append(ipInReceives).append(ipInHdrErrors).append(ipInAddrErrors).append(ipForwDatagrams).append(ipInUnknownProtos).append(ipInDiscards).append(ipInDelivers).append(ipOutRequests).append(ipOutDiscards).append(ipOutNoRoutes).append(ipReasmTimeout).append(ipReasmReqds).append(ipReasmOKs).append(ipReasmFails).append(ipFragOKs).append(ipFragFails).append(ipFragCreates).append(ipRoutingDiscards).append(ipv6IpForwarding).append(ipv6IpDefaultHopLimit).append(ipv4InterfaceTableLastChange).append(ipv6InterfaceTableLastChange).append(ipAddressSpinLock).append(ipv6RouterAdvertSpinLock).toHashCode();
    }
    ...
    public Ip clone() {
        ...
        _copy.ipv6IpForwarding = ipv6IpForwarding;
        _copy.ipv6IpDefaultHopLimit = ipv6IpDefaultHopLimit;
        _copy.ipv4InterfaceTableLastChange = ipv4InterfaceTableLastChange;
        _copy.ipv6InterfaceTableLastChange = ipv6InterfaceTableLastChange;
        _copy.ipAddressSpinLock = ipAddressSpinLock;
        _copy.ipv6RouterAdvertSpinLock = ipv6RouterAdvertSpinLock;
        return _copy;
    }
    ...
    private static DeviceEntityDescription createEntityDescription() {
        ...
        description.addField(new DeviceEntityDescription.FieldDescription(25, "ipv6IpForwarding", DeviceEntityDescription.FieldType.INTEGER, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(26, "ipv6IpDefaultHopLimit", DeviceEntityDescription.FieldType.INTEGER, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(27, "ipv4InterfaceTableLastChange", DeviceEntityDescription.FieldType.INTEGER, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(29, "ipv6InterfaceTableLastChange", DeviceEntityDescription.FieldType.INTEGER, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(33, "ipAddressSpinLock", DeviceEntityDescription.FieldType.INTEGER, -1));
        description.addField(new DeviceEntityDescription.FieldDescription(38, "ipv6RouterAdvertSpinLock", DeviceEntityDescription.FieldType.INTEGER, -1));
        return description;
    }
