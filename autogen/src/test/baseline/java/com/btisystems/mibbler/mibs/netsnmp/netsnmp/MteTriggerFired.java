    ...
    implements Serializable, INotification
{
    ...
    public boolean equals(Object obj) {
        ...
        MteTriggerFired rhs = ((MteTriggerFired) obj);
    ...
    public MteTriggerFired clone() {
        MteTriggerFired _copy = new MteTriggerFired();
    ...
    private static DeviceEntityDescription createEntityDescription() {
        DeviceEntityDescription description = new DeviceEntityDescription(new OID("1.3.6.1.2.1.88.2.0.1"));
